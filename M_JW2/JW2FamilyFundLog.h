...
class CJW2FamilyFundLog : public CDialog
{
	DECLARE_DYNAMIC(CJW2FamilyFundLog)

public:
	CJW2FamilyFundLog(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CJW2FamilyFundLog();

// 对话框数据
	enum { IDD = IDD_DLGFAMILYFUNDLOG };
