...
class CJW2CoupleCard : public CDialog
{
	DECLARE_DYNAMIC(CJW2CoupleCard)

public:
	CJW2CoupleCard(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CJW2CoupleCard();

// 对话框数据
	enum { IDD = IDD_DLGCOUPLECARD };
