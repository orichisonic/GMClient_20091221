...
// CJW2WeddingPaper 对话框

IMPLEMENT_DYNAMIC(CJW2WeddingPaper, CDialog)
CJW2WeddingPaper::CJW2WeddingPaper(CWnd* pParent /*=NULL*/)
	: CDialog(CJW2WeddingPaper::IDD, pParent)
{
}

CJW2WeddingPaper::~CJW2WeddingPaper()
{
}

void CJW2WeddingPaper::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CJW2WeddingPaper, CDialog)
...
// 初始化对话框
BOOL CJW2WeddingPaper::OnInitDialog()
{
...
void CJW2WeddingPaper::InitUI()
{
	...
	tbcResult.InsertItem(1,theApp.operJW2.ReadValue("MJW2","WP_UI_tpgWeddingPaper"));

}

//处理快捷键响应函数
BOOL CJW2WeddingPaper::PreTranslateMessage(MSG* pMsg)
{
...
// 自动改变大小
void CJW2WeddingPaper::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CJW2WeddingPaper::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CJW2WeddingPaper::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
...
// 查询玩家资料信息
void CJW2WeddingPaper::UserInfo()
{	
...
// 翻页查询玩家资料信息
void CJW2WeddingPaper::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
...
// 单击用户列表保存当前行号
void CJW2WeddingPaper::OnNMClickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CJW2WeddingPaper::OnNMDblclkListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listUser.GetItemCount() != 0)
...
// 切换选项卡进行查询
void CJW2WeddingPaper::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
...
// 查询情侣信息
void CJW2WeddingPaper::WeddingPaper()
{
	try
	{		
		CIni mIni;
		...
		int midlength = socketdata.EnBody();
		theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_Wedding_Paper);
...
// 翻页进行查询
void CJW2WeddingPaper::OnCbnSelchangeCmbuipage()
{
	...
	try
	{
		if(pageInfo)
		{
			...
			int midlength = socketdata.EnBody();				
			theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_Wedding_Paper);// 查询玩家故事情节信息
...
// 接收返回信息
LRESULT CJW2WeddingPaper::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
//单击用户资料信息的列名进行排序
void CJW2WeddingPaper::OnLvnColumnclickListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
...
//单击结果信息的列名进行排序
void CJW2WeddingPaper::OnLvnColumnclickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 关闭对话框
void CJW2WeddingPaper::OnBnClickedUicancel()
{
