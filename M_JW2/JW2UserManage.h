...
class CJW2UserManage : public CDialog
{
	DECLARE_DYNAMIC(CJW2UserManage)

public:
	CJW2UserManage(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CJW2UserManage();
...
public:
	...
	//显示修改用户
	void ShowModifyUser(int n_cmdShow);

	//显示修改密码
	void ShowModifyPWD(int n_cmdShow);
	void InitModifyType(void);
	CComboBox cmbModifyType;
