...
// CJW2FamilyBuyLog 对话框

class CJW2FamilyBuyLog : public CDialog
{
	DECLARE_DYNAMIC(CJW2FamilyBuyLog)

public:
	CJW2FamilyBuyLog(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CJW2FamilyBuyLog();

// 对话框数据
	enum { IDD = IDD_DLGFAMILYBUYLOG };
