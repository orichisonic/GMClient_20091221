...
IMPLEMENT_DYNAMIC(CJW2UserInfo, CDialog)
CJW2UserInfo::CJW2UserInfo(CWnd* pParent /*=NULL*/)
	: CDialog(CJW2UserInfo::IDD, pParent)
{
}

CJW2UserInfo::~CJW2UserInfo()
{
}

void CJW2UserInfo::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CJW2UserInfo, CDialog)
...
// 初始化对话框
BOOL CJW2UserInfo::OnInitDialog()
{
...
//处理快捷键响应函数
BOOL CJW2UserInfo::PreTranslateMessage(MSG* pMsg)
{
...
// 自动改变大小
void CJW2UserInfo::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CJW2UserInfo::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CJW2UserInfo::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
...
// 翻页查询玩家资料信息
void CJW2UserInfo::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
...
// 单击用户列表保存当前行号
void CJW2UserInfo::OnNMClickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CJW2UserInfo::OnNMDblclkListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listUser.GetItemCount() != 0)
...
// 切换选项卡进行查询
void CJW2UserInfo::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
...
// 查询玩家房间道具信息
void CJW2UserInfo::HomeItemInfo()
{
...
// 选择不同类型查询玩家购物送礼记录
void CJW2UserInfo::OnCbnSelchangeCmbtype()
{
...
// 翻页进行查询
void CJW2UserInfo::OnCbnSelchangeCmbuipage()
{
...
// 接收返回信息
LRESULT CJW2UserInfo::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
//单击用户资料信息的列名进行排序
void CJW2UserInfo::OnLvnColumnclickListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
...
//单击结果信息的列名进行排序
void CJW2UserInfo::OnLvnColumnclickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 关闭对话框
void CJW2UserInfo::OnBnClickedUicancel()
{
...
//初始化购物送礼类型
void CJW2UserInfo::InitGiftType()
{
