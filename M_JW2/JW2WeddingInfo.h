...
class CJW2WeddingInfo : public CDialog
{
	DECLARE_DYNAMIC(CJW2WeddingInfo)

public:
	CJW2WeddingInfo(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CJW2WeddingInfo();

// 对话框数据
	enum { IDD = IDD_DLGWEDDINGINFO };
