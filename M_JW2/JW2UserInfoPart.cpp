...
// CJW2UserInfoPart 对话框

IMPLEMENT_DYNAMIC(CJW2UserInfoPart, CDialog)
CJW2UserInfoPart::CJW2UserInfoPart(CWnd* pParent /*=NULL*/)
	: CDialog(CJW2UserInfoPart::IDD, pParent)
{
}

CJW2UserInfoPart::~CJW2UserInfoPart()
{
}

void CJW2UserInfoPart::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CJW2UserInfoPart, CDialog)
...
// 初始化对话框
BOOL CJW2UserInfoPart::OnInitDialog()
{
...
void CJW2UserInfoPart::InitUI()
{
	...
	//tbcResult.InsertItem(1,theApp.operJW2.ReadValue("MJW2","UIC_UI_tpgUserLevel"));
	//tbcResult.InsertItem(2,theApp.operJW2.ReadValue("MJW2","UIC_UI_tpgUserStory"));
	//tbcResult.InsertItem(3,theApp.operJW2.ReadValue("MJW2","UIC_UI_tpgUserItem"));
	//tbcResult.InsertItem(4,theApp.operJW2.ReadValue("MJW2","UIC_UI_tpgUserPresent"));
	//tbcResult.InsertItem(5,theApp.operJW2.ReadValue("MJW2","UIC_UI_tpgUserConsume"));
	//tbcResult.InsertItem(6,theApp.operJW2.ReadValue("MJW2","UIC_UI_tpgUserBugle"));
	//tbcResult.InsertItem(7,theApp.operJW2.ReadValue("MJW2","UIC_UI_tpgUserFamily"));
...
//处理快捷键响应函数
BOOL CJW2UserInfoPart::PreTranslateMessage(MSG* pMsg)
{
...
// 自动改变大小
void CJW2UserInfoPart::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CJW2UserInfoPart::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CJW2UserInfoPart::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
...
// 查询玩家资料信息
void CJW2UserInfoPart::UserInfo()
{	
...
// 翻页查询玩家资料信息
void CJW2UserInfoPart::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
...
// 单击用户列表保存当前行号
void CJW2UserInfoPart::OnNMClickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CJW2UserInfoPart::OnNMDblclkListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listUser.GetItemCount() != 0)
...
// 切换选项卡进行查询
void CJW2UserInfoPart::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
...
// 查询玩家故事情节信息
void CJW2UserInfoPart::StoryInfo()
{
	try
	{		
		CIni mIni;
		...
		int midlength = socketdata.EnBody();
		theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_RPG_QUERY);
...
// 查询玩家身上道具信息
void CJW2UserInfoPart::ItemInfo()
{
	try
	{		
	    CIni mIni;
		...
		int midlength = socketdata.EnBody();
		theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_ITEMSHOP_BYOWNER_QUERY);
...
// 查询玩家房间道具信息
void CJW2UserInfoPart::HomeItemInfo()
{
	...
	{		
		...
		int midlength = socketdata.EnBody();
		theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_HOME_ITEM_QUERY);
...
// 查询玩家购物送礼记录
void CJW2UserInfoPart::PresentInfo()
{
...
// 选择不同类型查询玩家购物送礼记录
void CJW2UserInfoPart::OnCbnSelchangeCmbtype()
{
...
// 查询玩家消耗性道具使用
void CJW2UserInfoPart::ConsumeItem()
{
...
// 查询玩家小喇叭发送记录
void CJW2UserInfoPart::BugleSend()
{
...
//用户家族
void CJW2UserInfoPart::UserFamily()
{
...
// 翻页进行查询
void CJW2UserInfoPart::OnCbnSelchangeCmbuipage()
{
...
// 接收返回信息
LRESULT CJW2UserInfoPart::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
//单击用户资料信息的列名进行排序
void CJW2UserInfoPart::OnLvnColumnclickListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
...
//单击结果信息的列名进行排序
void CJW2UserInfoPart::OnLvnColumnclickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 关闭对话框
void CJW2UserInfoPart::OnBnClickedUicancel()
{
...
//初始化购物送礼类型
void CJW2UserInfoPart::InitGiftType()
{
	cmbType.ResetContent();
	cmbType.AddString(theApp.operJW2.ReadValue("MJW2","UIC_Code_ALL"));
	cmbType.AddString(theApp.operJW2.ReadValue("MJW2","UIC_Code_BuyByM"));
	cmbType.AddString(theApp.operJW2.ReadValue("MJW2","UIC_Code_BuyByG"));	
	cmbType.SetCurSel(0);
}
