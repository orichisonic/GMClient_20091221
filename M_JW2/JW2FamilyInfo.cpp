...
IMPLEMENT_DYNAMIC(CJW2FamilyInfo, CDialog)
CJW2FamilyInfo::CJW2FamilyInfo(CWnd* pParent /*=NULL*/)
	: CDialog(CJW2FamilyInfo::IDD, pParent)
{
}

CJW2FamilyInfo::~CJW2FamilyInfo()
{
}

void CJW2FamilyInfo::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CJW2FamilyInfo, CDialog)
...
// 初始化对话框
BOOL CJW2FamilyInfo::OnInitDialog()
{
...
void CJW2FamilyInfo::InitUI()
{
	...
	tbcResult.InsertItem(1,theApp.operJW2.ReadValue("MJW2","FI_UI_tpgFamilyMember"));
	tbcResult.InsertItem(2,theApp.operJW2.ReadValue("MJW2","FI_UI_tpgBasicInfo"));
	tbcResult.InsertItem(3,theApp.operJW2.ReadValue("MJW2","FI_UI_tpgBasicRank"));
	tbcResult.InsertItem(4,theApp.operJW2.ReadValue("MJW2","FI_UI_tpgMemberApplying"));

}

//处理快捷键响应函数
BOOL CJW2FamilyInfo::PreTranslateMessage(MSG* pMsg)
{
...
// 自动改变大小
void CJW2FamilyInfo::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CJW2FamilyInfo::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CJW2FamilyInfo::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
...
// 查询玩家资料信息
void CJW2FamilyInfo::FamilyInfo()
{	
...
// 翻页查询玩家资料信息
void CJW2FamilyInfo::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
...
// 单击用户列表保存当前行号
void CJW2FamilyInfo::OnNMClickListfamily(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CJW2FamilyInfo::OnNMDblclkListfamily(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listFamily.GetItemCount() != 0)
...
// 切换选项卡进行查询
void CJW2FamilyInfo::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
...
// 查询家族成员信息
void CJW2FamilyInfo::FamilyMember()
{
	try
	{		
		CIni mIni;
		...
		int midlength = socketdata.EnBody();
		theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_FAMILYMEMBER_QUERY);
...
void CJW2FamilyInfo::BasicInfo()
{
	...
	{		
		...
		int midlength = socketdata.EnBody();
		theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_BasicInfo_Query);
...
void CJW2FamilyInfo::BasicRank()
{
	...
	{		
		...
		int midlength = socketdata.EnBody();
		theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_BasicRank_Query);
...
// 查询申请中成员
void CJW2FamilyInfo::MemberApplying()
{
	try
	{		
		CIni mIni;
		...
		int midlength = socketdata.EnBody();
		theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_FamilyMember_Applying);
...
// 翻页进行查询
void CJW2FamilyInfo::OnCbnSelchangeCmbuipage()
{
	...
	try
	{
		if(pageInfo)
		{
			...
			{
				theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_BasicInfo_Query);// 查询玩家故事情节信息
			}
			else if(tbcResult.GetCurSel() == 3)
			{
				theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_BasicRank_Query);// 查询玩家故事情节信息
			}
			else if(tbcResult.GetCurSel() == 4)
			{
				theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_FamilyMember_Applying);// 查询玩家故事情节信息
			}
...
// 接收返回信息
LRESULT CJW2FamilyInfo::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
//单击用户资料信息的列名进行排序
void CJW2FamilyInfo::OnLvnColumnclickListfamily(NMHDR *pNMHDR, LRESULT *pResult)
{
...
//单击结果信息的列名进行排序
void CJW2FamilyInfo::OnLvnColumnclickListresult(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 关闭对话框
void CJW2FamilyInfo::OnBnClickedUicancel()
{
