...
// CJW2FamilyTransfer 对话框

IMPLEMENT_DYNAMIC(CJW2FamilyTransfer, CDialog)
CJW2FamilyTransfer::CJW2FamilyTransfer(CWnd* pParent /*=NULL*/)
	: CDialog(CJW2FamilyTransfer::IDD, pParent)
{
}

CJW2FamilyTransfer::~CJW2FamilyTransfer()
{
}

void CJW2FamilyTransfer::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CJW2FamilyTransfer, CDialog)
...
// 初始化对话框
BOOL CJW2FamilyTransfer::OnInitDialog()
{
...
// 初始化显示字符
void CJW2FamilyTransfer::InitUI()
{
	...
	tbcResult.InsertItem(1,theApp.operJW2.ReadValue("MJW2","FT_UI_tpgFmailyTransfer"));

}

//处理快捷键响应函数
BOOL CJW2FamilyTransfer::PreTranslateMessage(MSG* pMsg)
{
...
// 自动改变大小
void CJW2FamilyTransfer::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CJW2FamilyTransfer::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CJW2FamilyTransfer::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
		...
		GetDlgItemText(IDC_EDITUIACCOUNT,FamilyName);//获取玩家帐号
...
// 查询玩家资料信息
void CJW2FamilyTransfer::FamilyInfo()
{	
...
// 翻页查询玩家资料信息
void CJW2FamilyTransfer::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
		if(pageUInfo)//如果可以翻页的话
		{
			...
			int midlength = socketdata.EnBody();
			operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_FAMILYINFO_QUERY);//发送查询玩家资料信息的请求
...
// 单击用户列表保存当前行号
void CJW2FamilyTransfer::OnNMClickListfamily(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CJW2FamilyTransfer::OnNMDblclkListfamily(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listFamily.GetItemCount() != 0)
...
// 切换选项卡进行查询
void CJW2FamilyTransfer::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
...
// 查询家族转让信息
void CJW2FamilyTransfer::FamilyTransfer()
{
	try
	{		
		CIni mIni;
		...
		int midlength = socketdata.EnBody();
		theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_FamilyTransfer_Query);
...
// 翻页进行查询
void CJW2FamilyTransfer::OnCbnSelchangeCmbuipage()
{
...
// 接收返回信息
LRESULT CJW2FamilyTransfer::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
//单击用户资料信息的列名进行排序
void CJW2FamilyTransfer::OnLvnColumnclickListfamily(NMHDR *pNMHDR, LRESULT *pResult)
{
...
//单击结果信息的列名进行排序
void CJW2FamilyTransfer::OnLvnColumnclickListresult(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 关闭对话框
void CJW2FamilyTransfer::OnBnClickedUicancel()
{
...
// 关闭对话框
void CJW2FamilyTransfer::OnClose()
{
