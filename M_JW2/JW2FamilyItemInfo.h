...
class CJW2FamilyItemInfo : public CDialog
{
	DECLARE_DYNAMIC(CJW2FamilyItemInfo)

public:
	CJW2FamilyItemInfo(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CJW2FamilyItemInfo();

// 对话框数据
	enum { IDD = IDD_DLGFAMILYITEMINFO };
