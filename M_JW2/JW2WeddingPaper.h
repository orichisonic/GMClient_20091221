...
class CJW2WeddingPaper : public CDialog
{
	DECLARE_DYNAMIC(CJW2WeddingPaper)

public:
	CJW2WeddingPaper(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CJW2WeddingPaper();

// 对话框数据
	enum { IDD = IDD_DLGWEDDINGPAPER };
