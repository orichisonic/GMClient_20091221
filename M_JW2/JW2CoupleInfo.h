...
class CJW2CoupleInfo : public CDialog
{
	DECLARE_DYNAMIC(CJW2CoupleInfo)

public:
	CJW2CoupleInfo(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CJW2CoupleInfo();

// 对话框数据
	enum { IDD = IDD_DLGCOUPLEINFO };
