...
IMPLEMENT_DYNAMIC(CJW2HouseInfo, CDialog)
CJW2HouseInfo::CJW2HouseInfo(CWnd* pParent /*=NULL*/)
	: CDialog(CJW2HouseInfo::IDD, pParent)
{
}

CJW2HouseInfo::~CJW2HouseInfo()
{
}

void CJW2HouseInfo::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CJW2HouseInfo, CDialog)
...
// 初始化对话框
BOOL CJW2HouseInfo::OnInitDialog()
{
...
void CJW2HouseInfo::InitUI()
{
	...
	tbcResult.InsertItem(1,theApp.operJW2.ReadValue("MJW2","HI_UI_tpgHouseInfo"));


}

//处理快捷键响应函数
BOOL CJW2HouseInfo::PreTranslateMessage(MSG* pMsg)
{
...
// 自动改变大小
void CJW2HouseInfo::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CJW2HouseInfo::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CJW2HouseInfo::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
...
// 翻页查询玩家资料信息
void CJW2HouseInfo::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
...
// 单击用户列表保存当前行号
void CJW2HouseInfo::OnNMClickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CJW2HouseInfo::OnNMDblclkListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listUser.GetItemCount() != 0)
...
// 切换选项卡进行查询
void CJW2HouseInfo::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
...
// 翻页进行查询
void CJW2HouseInfo::OnCbnSelchangeCmbuipage()
{
	...
	try
	{
		if(pageInfo)
		{
			...
			int midlength = socketdata.EnBody();				
			theApp.operJW2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::JW2_HOME_ITEM_QUERY);// 查询玩家故事情节信息
...
// 接收返回信息
LRESULT CJW2HouseInfo::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
//单击用户资料信息的列名进行排序
void CJW2HouseInfo::OnLvnColumnclickListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
...
//单击结果信息的列名进行排序
void CJW2HouseInfo::OnLvnColumnclickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 关闭对话框
void CJW2HouseInfo::OnBnClickedUicancel()
{
