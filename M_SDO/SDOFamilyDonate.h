...
class CSDOFamilyDonate : public CSDOFamilyBaseDlg
{
public:
	CSDOFamilyDonate(CWnd* pParent = NULL);
	~CSDOFamilyDonate(void);
...
protected:
	...
	afx_msg void OnMenuCmdQueryDonate();
	afx_msg void OnLvnColumnclickListDonateInfo(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnCbnSelchangeCmbDonateInfo();
...
private:
	...
	//查询家族捐赠信息
	CListCtrl	m_listFamilyDonate;
	CComboBox	m_cmbFamilyDonate;
public:
	virtual BOOL OnInitDialog();

	//查询家族捐赠信息
	void QueryDonate(CString& curPage);
