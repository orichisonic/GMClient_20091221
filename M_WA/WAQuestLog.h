...
class CWAQuestLog : public CDialog
{
	DECLARE_DYNAMIC(CWAQuestLog)

public:
	CWAQuestLog(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CWAQuestLog();

// 对话框数据
	enum { IDD = IDD_DLGQUESTLOG };
...
public:
	...
	//角色任务日志
	void CharQuestLog(CString logType);
