...
public:
	...
	{    
		...
		{      
			...
			PlayerInServer	= 0x0209,	//玩家所在服务区
			RealmIP			= 0x0210,   //大区IP
			GM_AccountInfo_Vip = 0x0211, // 是否vip帐号
			...
			GT_UserState = 0x2033,//用户状态(玩家是否封停)
			...
			JW2_Money = 0x3015, //Format:Integer 金钱
			...
			JW2_CNT=0x3103,//人数
			JW2_POINT=0x3104,//积分
			JW2_LOGINTYPE=0x3105,//登入类型0登入，1登出
			JW2_TIME=0x3106,//时间
			JW2_IP=0x3107,//IP地址
			JW2_PWD=0x3108,//密码
			...
			WA_MailTag=0x4187, //是否群发邮件       发送指定玩家:  0,   在线玩家:   1
			...
			CG2_SkillLevel = 0x5051,//技能等级
			CG2_SkillExp = 0x5052,//技能经验

			CG2_EquipNum = 0x5053,//装备号
			CG2_ItemColNum = 0x5054,//道具栏号
			CG2_CombineNum = 0x5055,//合并放置数
			CG2_ItemName = 0x5056,//道具名称
			...
			SDO_ItemName1 = 0x8152,//TLV_STRING  道具ID
			SDO_ItemName2 = 0x8153,//TLV_STRING  道具ID
			SDO_ItemName3 = 0x8154,//TLV_STRING  道具ID
			SDO_ItemName4 = 0x8155,//TLV_STRING  道具ID
			SDO_ItemName5 = 0x8156,//TLV_STRING  道具ID
			SDO_KeyPress = 0x8158,
			SDO_LoginErr = 0x8159,
			...
			SDO_FamilyName = 0x8181,//string 家族名称
			SDO_FamilyID = 0x8182,//int 家族ID
			...
			//XDJG_Account=0x6003,//帐号
			//XDJG_UserNick=0x6004,//角色名
			//XDJG_BeginDate=0x6005,//开始时间
			//XDJG_EndDate=0x6006,//结束时间
			//XDJG_AccountID=0x6007,//帐号数据库ID
			//XDJG_NickID=0x6008,//角色数据库ID
			//XDJG_Time=0x6009,//时间
			//XDJG_Level=0x6010,//等级
			//XDJG_Exp=0x6011,//经验			
			//XDJG_Sex=0x6012,//性别
			//XDJG_Profession=0x6013,//职业
			//XDJG_SceneTypeID=0x6014,//场景类型id
			//XDJG_SceneInstanceID=0x6015,//场景实例id
			//XDJG_Position=0x6016,//位置
			//XDJG_Money=0x6017,//金钱数

			//XDJG_TaskID=0x6049,//公告ID
			//XDJG_BoardMessage=0x6050,//公告内容
			//XDJG_Interval=0x6051,//间隔时间
			//XDJG_StartTime=0x6052,//公告开始时间
			//XDJG_Repeat=0x6053,//重复次数
   //        
			//XDJG_NextTime=0x6056,//下次公告时间
			//XDJG_ExecTimes=0x6057,//执行次数
			//XDJG_Onoff=0x6058,//公告开关
			//XDJG_GMSERVERIPNAME=0x6060,
			//XDJG_SEARCHTYPE=0x6061,
			//XDJG_BANREASON=0x6062,//封停原因
			//XDJG_UNBANREASON=0x6063,//解封原因
			//XDJG_BANTIME=0x6064,//封停时间
			//XDJG_BANBEGINTIME=0x6065,//封停开始时间
			//XDJG_BANENDTIME=0x6066,//封停结束时间
			//XDJG_ENDTIME=0x6067,//公告结束时间
			XDJG_ServerIP=0x6002,//服务器IP
	...
	{    
		...
		{      
			...
			PAL_MODIFYCHARACTERMONEY_RESP=0x0014,//修改角色金钱响应

			PAL_MODIFYCHARACTERDROPPW=0x0015,//修改角色删除密码
			PAL_MODIFYCHARACTERDROPPW_RESP=0x0015,//修改角色删除密码响应
			...
			PAL_EQUIPMENT_QUERY_RESP=0x8061,

			PAL_SENDCUSTOMITEMMAIL=0x0062,//发送客制物品
			PAL_SENDCUSTOMITEMMAIL_RESP=0x8062,
			...
			//查询玩家使用道具日志(收费道具)
			GT_UseItemLog_Query = 0x0026,
			GT_UseItemLog_Query_Resp = 0x8026,
			...
			JW2_WEDDINGGROUNND_QUERY=0x0019,//结婚信息
			JW2_WEDDINGGROUNND_QUERY_RESP=0x8019,
			...
			JW2_BasicRank_Query_Resp=0x8032,
            ...
            SDO_Family_Donate_Query_RES = 0x8130,//家族金库捐赠明细
            ...
            SDO_Family_CONSUME_QUERY = 0x0125,//家族消费查询
            SDO_Family_CONSUME_QUERY_RESP = 0x8125,//家族消费查询
			...
			SDO_PCash_Update=0x0138,//修改红利点数
			SDO_PCash_Update_Resp=0x8138,
			SDO_Friend_Query=0x0139,//好友信息查询
			SDO_Friend_Query_Resp=0x8139,
			SDO_Friend_Delete=0x0140,//删除好友
			SDO_Friend_Delete_Resp=0x8140,
			...
			//servicekey:Added by tengjie 2010-07-06
			//角色技能添加
	...
	{    
		...
		{      
			...
			GM_AccountInfo_Vip = 0x800020, //查询是否vip帐号
			GM_AccountInfo_Resp = 0x808020, // 服务器端响应查询vip帐号

			GM_ClosePlayerGroup_WA = 0x800116,  //封停帐号
			GM_ClosePlayerGroup_Resp_WA = 0x808116, //封停帐号响应
			...
			//PAL_CHECKMAILBOX_QUERY=0x620036,//邮箱信息查询
			//PAL_CHECKMAILBOX_QUERY_RESP=0x628036,//邮箱信息查询响应
			...
			PAL_CHECKMAILBOX_DETAIL_RESP=0x638043,//邮箱附件查询响应
			...
			PAL_EQUIPMENT_QUERY_RESP=0x638061,

			PAL_SENDCUSTOMITEMMAIL=0x620062,//发送客制物品
			PAL_SENDCUSTOMITEMMAIL_RESP=0x628062,
...
// 			//徽章获得时间
			...
			JW2_BasicRank_Query_Resp=0x618032,
			...
			CG2_GetPetSkill_Query_Resp = 0x718067,//获得宠物技能类型
			...
			SDO_PCash_Update=0x870138,//修改红利点数
			SDO_PCash_Update_Resp=0x878138,
			SDO_Friend_Query=0x870139,//好友信息查询
			SDO_Friend_Query_Resp=0x878139,
			SDO_Friend_Delete=0x870140,//删除好友
			SDO_Friend_Delete_Resp=0x878140,
			...
			//查询服务器列表
            XDJG_SERVERINFO_IP_QUERY=0x550011,
			XDJG_SERVERINFO_IP_QUERY_RESP=0x558011,
			/////////peng end
