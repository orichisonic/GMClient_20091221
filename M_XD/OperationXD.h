...
public:
	...
	// 构造复选框
	bool BuildCombox(CSocketData* socketData,CComboBox* cmbSelect,int nItem);

	// 构造复选框
	bool BuildComboxs(CSocketData* socketData,CComboBox* cmbSelect,CEnumCore::TagName tag);
