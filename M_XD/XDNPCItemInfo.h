...
class CXDNPCItemInfo : public CDialog
{
	DECLARE_DYNAMIC(CXDNPCItemInfo)

public:
	CXDNPCItemInfo(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CXDNPCItemInfo();

// 对话框数据
	enum { IDD = IDD_DLGGETNPCITEM };
