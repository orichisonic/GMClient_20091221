...
class CGTOWNRoleManagePart : public CDialog
{
	DECLARE_DYNAMIC(CGTOWNRoleManagePart)

public:
	CGTOWNRoleManagePart(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CGTOWNRoleManagePart();

	// 对话框数据
	enum { IDD = IDD_DLGROLEMANAGEPART };
