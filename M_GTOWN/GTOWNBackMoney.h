...
// CGTOWNBackMoney 对话框
class CGTOWNBackMoney : public CDialog
{
	DECLARE_DYNAMIC(CGTOWNBackMoney)

public:
	CGTOWNBackMoney(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CGTOWNBackMoney();

	// 对话框数据
	enum { IDD = IDD_DLGBACKMONEY };
