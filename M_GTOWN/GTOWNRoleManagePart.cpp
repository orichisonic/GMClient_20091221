...
// CGTOWNRoleManagePart 对话框

IMPLEMENT_DYNAMIC(CGTOWNRoleManagePart, CDialog)
CGTOWNRoleManagePart::CGTOWNRoleManagePart(CWnd* pParent /*=NULL*/)
: CDialog(CGTOWNRoleManagePart::IDD, pParent)
{
}

CGTOWNRoleManagePart::~CGTOWNRoleManagePart()
{
}

void CGTOWNRoleManagePart::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CGTOWNRoleManagePart, CDialog)
	ON_WM_SIZE()
	ON_WM_CTLCOLOR()
...
// CGTOWNRoleManagePart 消息处理程序

//初始化对话框
BOOL CGTOWNRoleManagePart::OnInitDialog()
{
...
//初始化显示字符
void CGTOWNRoleManagePart::InitUI()
{
...
//处理快捷键响应函数
BOOL CGTOWNRoleManagePart::PreTranslateMessage(MSG* pMsg)
{
...
//自动改变大小
void CGTOWNRoleManagePart::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CGTOWNRoleManagePart::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
//查询玩家资料信息
void CGTOWNRoleManagePart::OnBnClickedSearch()
{
	try
	{
		CIni mIni;
...
//翻页查询玩家资料信息
void CGTOWNRoleManagePart::OnCbnSelchangeCmbpage()
{
	try
	{	
...
// 单击用户列表保存当前行号
void CGTOWNRoleManagePart::OnNMClickListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息将玩家角色移动至黑屋
void CGTOWNRoleManagePart::OnNMDblclkListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
	try
	{
		if(listUser.GetItemCount() > 0)
...
//将选定玩家角色移至黑屋
void CGTOWNRoleManagePart::OnBnClickedBtnmoveuuser()
{
	try
	{
		CIni mIni;
...
//重设玩家到出生状态
void CGTOWNRoleManagePart::OnBnClickedBtnresetstatus()
{
	try
	{
		CIni mIni;
...
//重置玩家昵称信息
void CGTOWNRoleManagePart::OnBnClickedBtnreset()
{
	SetDlgItemText(IDC_EDITNICK, "");
}

// 接收返回信息
LRESULT CGTOWNRoleManagePart::OnMessageReceive(WPARAM wParam,LPARAM lParam)
{
...
//单击用户资料信息的列名进行排序
void CGTOWNRoleManagePart::OnLvnColumnclickListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
	theApp.operGTOWN.SortListInfo(&listUser,pNMHDR,pResult);
}

//选择是否显示相应的控件信息
void CGTOWNRoleManagePart::ShowOperCtrl(int nCmdShow)
{
...
// 关闭对话框
void CGTOWNRoleManagePart::OnBnClickedCancel()
{
...
//响应WM_CLOSE消息
void CGTOWNRoleManagePart::OnClose()
{
...
void CGTOWNRoleManagePart::OnBnClickedBtnclearname()
{
