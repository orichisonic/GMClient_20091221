...
class CGTOWNFriendTrade : public CDialog
{
	DECLARE_DYNAMIC(CGTOWNFriendTrade)

public:
	CGTOWNFriendTrade(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CGTOWNFriendTrade();

// 对话框数据
	enum { IDD = IDD_DLGFRIENDTRADE };
