...
class CGTOWNPictureManage : public CDialog
{
	DECLARE_DYNAMIC(CGTOWNPictureManage)

public:
	CGTOWNPictureManage(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CGTOWNPictureManage();

// 对话框数据
	enum { IDD = IDD_DLGPICTUREMANAGE };
