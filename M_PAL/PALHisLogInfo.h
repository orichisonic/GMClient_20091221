...
class CPALHisLogInfo : public CDialog
{
	DECLARE_DYNAMIC(CPALHisLogInfo)

public:
	CPALHisLogInfo(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CPALHisLogInfo();

// 对话框数据
	enum { IDD = IDD_DLGHISLOGINFO };
