...
class CCG2ChangeCharNo : public CDialog
{
	DECLARE_DYNAMIC(CCG2ChangeCharNo)

public:
	CCG2ChangeCharNo(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCG2ChangeCharNo();

// 对话框数据
	enum { IDD = IDD_DLGCHANGECHARNO };
...
public:
	...
	CComboBox cmbNewCharNo;
	void InitCmbCharNo(void);
