...
class CCG2RecallLogPet : public CDialog
{
	DECLARE_DYNAMIC(CCG2RecallLogPet)

public:
	CCG2RecallLogPet(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCG2RecallLogPet();

// 对话框数据
	enum { IDD = IDD_DLGRECALLLOGPET };
