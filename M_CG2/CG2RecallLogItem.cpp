...
// CCG2RecallLogItem 对话框

IMPLEMENT_DYNAMIC(CCG2RecallLogItem, CDialog)
CCG2RecallLogItem::CCG2RecallLogItem(CWnd* pParent /*=NULL*/)
	: CDialog(CCG2RecallLogItem::IDD, pParent)
{
}

CCG2RecallLogItem::~CCG2RecallLogItem()
{
}

void CCG2RecallLogItem::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCG2RecallLogItem, CDialog)
...
// 初始化对话框
BOOL CCG2RecallLogItem::OnInitDialog()
{
...
void CCG2RecallLogItem::InitUI()
{
	...
	SetDlgItemText(IDC_LBL1,theApp.operCG2.ReadValue("MCG2","NI_UI_StartTime"));
	SetDlgItemText(IDC_LBL2,theApp.operCG2.ReadValue("MCG2","NI_UI_EndTime "));
	SetDlgItemText(IDC_LBL3,theApp.operCG2.ReadValue("MCG2","RLI_UI_LogItemType"));
...
// 自动改变大小
void CCG2RecallLogItem::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CCG2RecallLogItem::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CCG2RecallLogItem::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
...
// 查询玩家资料信息
void CCG2RecallLogItem::UserInfo()
{	
	//OperationCG2 theApp.operCG2;
	try
	{		
...
// 翻页查询玩家资料信息
void CCG2RecallLogItem::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
...
// 单击用户列表保存当前行号
void CCG2RecallLogItem::OnNMClickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CCG2RecallLogItem::OnNMDblclkListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listUser.GetItemCount() > 0)
...
// 切换选项卡进行查询
void CCG2RecallLogItem::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
	//OperationCG2 theApp.operCG2;
...
// 银行存款信息
void CCG2RecallLogItem::BankInfo()
{
	//OperationCG2 theApp.operCG2;	
	try
	{		
...
// 查询银行物品信息
void CCG2RecallLogItem::BankItem()
{
	//OperationCG2 theApp.operCG2;	
	try
	{		
...
// 查询银行宠物信息
void CCG2RecallLogItem::BankPet()
{
	//OperationCG2 theApp.operCG2;
...
// 翻页进行查询
void CCG2RecallLogItem::OnCbnSelchangeCmbuipage()
{
	//OperationCG2 theApp.operCG2;	
	try
	{
...
// 接收返回信息
LRESULT CCG2RecallLogItem::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
// 关闭对话框
void CCG2RecallLogItem::OnBnClickedUicancel()
{
...
// 关闭对话框
void CCG2RecallLogItem::OnClose()
{
