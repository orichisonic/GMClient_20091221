...
class CCG2AccountBan : public CDialog
{
	DECLARE_DYNAMIC(CCG2AccountBan)

public:
	CCG2AccountBan(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCG2AccountBan();

// 对话框数据
	enum { IDD = IDD_DLGACCOUNTBAN };
