...
void CCG2LoginInfo::LoginInfo()
{
	...
	try
	{
		...
		theApp.operCG2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::CG2_Use_Query);//发送查询玩家资料信息的请求
...
{	
	try
	{
		...
		{	
			...
			int midlength = socketdata.EnBody();
			theApp.operCG2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::CG2_Use_Query);//当前的状态为发送查询请求
...
LRESULT CCG2LoginInfo::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{
	...
	case CEnumCore::Message_Tag_ID::SERVERINFO_IP_QUERY_RESP://查询服务器列表信息的回应
		...
		break;
	case CEnumCore::Message_Tag_ID::CG2_Use_Query_Resp://查询玩家登陆信息的回应
		{
