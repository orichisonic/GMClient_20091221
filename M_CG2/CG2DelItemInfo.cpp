...
IMPLEMENT_DYNAMIC(CCG2DelItemInfo, CDialog)
CCG2DelItemInfo::CCG2DelItemInfo(CWnd* pParent /*=NULL*/)
	: CDialog(CCG2DelItemInfo::IDD, pParent)
{
}

CCG2DelItemInfo::~CCG2DelItemInfo()
{
}

void CCG2DelItemInfo::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCG2DelItemInfo, CDialog)
...
// 初始化对话框
BOOL CCG2DelItemInfo::OnInitDialog()
{
...
void CCG2DelItemInfo::InitUI()
{
	...
	tbcResult.InsertItem(4,theApp.operCG2.ReadValue("MCG2","BU_UI_tpgBankItem"));

}


// 自动改变大小
void CCG2DelItemInfo::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CCG2DelItemInfo::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CCG2DelItemInfo::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
...
// 翻页查询玩家资料信息
void CCG2DelItemInfo::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
...
// 单击用户列表保存当前行号
void CCG2DelItemInfo::OnNMClickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CCG2DelItemInfo::OnNMDblclkListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listUser.GetItemCount() > 0)
...
//删除道具
void CCG2DelItemInfo::OnNMDblclkListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: 在此添加控件通知处理程序代码
	try
	{
		...
		if(listResult.GetItemCount() > 0)
		{
			...
			UserID = theApp.operCG2.GetValueByColName(&listUser, nItem, theApp.operCG2.ReadValue("MCG2","CG2_UserID"));// 保存选中的玩家ID
			UserNick = theApp.operCG2.GetValueByColName(&listUser, nItem, theApp.operCG2.ReadValue("MCG2","CG2_nickname"));// 保存选中的玩家昵称
			iCharNo=atoi(theApp.operCG2.GetValueByColName(&listUser, nItem, theApp.operCG2.ReadValue("MCG2","CG2_CharNo")));//角色号
			ItemName = theApp.operCG2.GetValueByColName(&listResult, nResultItem, theApp.operCG2.ReadValue("MCG2","CG2_ItemName"));// 保存选中的玩家昵称
			...
			socketdata.AddTFLV(CEnumCore::TagName::CG2_ItemName,CEnumCore::TagFormat::TLV_STRING,strlen(ItemName),(unsigned char *)mIni.wcharToChar(ItemName));//角色唯一IDKEY

		
			iSlot=atoi(theApp.operCG2.GetValueByColName(&listResult, nResultItem, theApp.operCG2.ReadValue("MCG2","CG2_SlotNum")));//角色号
			iItemId=atoi(theApp.operCG2.GetValueByColName(&listResult, nResultItem, theApp.operCG2.ReadValue("MCG2","CG2_PetItemID")));//道具ID
			_itoa(iSlot,strInt,10);
			socketdata.AddTFLV(CEnumCore::TagName::CG2_SlotNum,CEnumCore::TagFormat::TLV_INTEGER,sizeof(int),(unsigned char *)&strInt);//角色号
			_itoa(iItemId,strInt,10);
			socketdata.AddTFLV(CEnumCore::TagName::CG2_PetItemID,CEnumCore::TagFormat::TLV_INTEGER,sizeof(int),(unsigned char *)&strInt);//角色号
			...
			case 1:
				...
				theApp.operCG2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::CG2_BagItem_Del_Query);
				break;
			case 2:
				midlength=socketdata.EnBody();
				theApp.operCG2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::CG2_TmpItem_Del_Query);
				break;
			case 3:
				iItemNo=atoi(theApp.operCG2.GetValueByColName(&listResult, nResultItem, theApp.operCG2.ReadValue("MCG2","CG2_ItemColNum")));//道具ID
				_itoa(iItemNo,strInt,10);
				socketdata.AddTFLV(CEnumCore::TagName::CG2_ItemColNum,CEnumCore::TagFormat::TLV_INTEGER,sizeof(int),(unsigned char *)&strInt);//角色号

				midlength=socketdata.EnBody();
				theApp.operCG2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::CG2_EquipItem_Del_Query);
				break;
			case 4:
				midlength=socketdata.EnBody();
				theApp.operCG2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::CG2_BankItem_Del_Query);
				break;
			}
...
// 切换选项卡进行查询
void CCG2DelItemInfo::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
	//OperationCG2 theApp.operCG2;
...
// 翻页进行查询
void CCG2DelItemInfo::OnCbnSelchangeCmbuipage()
{
	//OperationCG2 theApp.operCG2;	
	try
	{
		if(pageInfo)
		{
			...
			if((listUser.GetItemCount() > 0) && (nItem>=0))
			{
				...
				{
					theApp.operCG2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::CG2_BankItem_Query );// 查询角色称号资料
				}
...
// 接收返回信息
LRESULT CCG2DelItemInfo::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
// 关闭对话框
void CCG2DelItemInfo::OnBnClickedUicancel()
{
...
BOOL CCG2DelItemInfo::PreTranslateMessage(MSG* pMsg)
{
