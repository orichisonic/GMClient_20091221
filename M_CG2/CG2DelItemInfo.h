...
class CCG2DelItemInfo : public CDialog
{
	DECLARE_DYNAMIC(CCG2DelItemInfo)

public:
	CCG2DelItemInfo(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCG2DelItemInfo();

// 对话框数据
	enum { IDD = IDD_DLGDELITEMINFO };
