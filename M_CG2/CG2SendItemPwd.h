...
class CCG2SendItemPwd : public CDialog
{
	DECLARE_DYNAMIC(CCG2SendItemPwd)

public:
	CCG2SendItemPwd(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CCG2SendItemPwd();

// 对话框数据
	enum { IDD = IDD_DLGSENDITEMPWD };
