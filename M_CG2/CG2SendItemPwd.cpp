...
IMPLEMENT_DYNAMIC(CCG2SendItemPwd, CDialog)
CCG2SendItemPwd::CCG2SendItemPwd(CWnd* pParent /*=NULL*/)
	: CDialog(CCG2SendItemPwd::IDD, pParent)
{
}

CCG2SendItemPwd::~CCG2SendItemPwd()
{
}

void CCG2SendItemPwd::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCG2SendItemPwd, CDialog)
	ON_WM_CLOSE()
...
// CCG2SendItemPwd 消息处理程序

BOOL CCG2SendItemPwd::OnInitDialog()
{
...
void CCG2SendItemPwd::InitUI()
{
	...
	SetDlgItemText(IDC_BTUPDATE,theApp.operCG2.ReadValue("MCG2","BU_UI_GetEMailAddress"));//IDC_STATICACCOUNT IDC_STATICCURJOB IDC_STATICNEWJOB
	SetDlgItemText(IDC_BTRESET,theApp.operCG2.ReadValue("MCG2","BU_UI_SendItemPwd"));//IDC_STATICACCOUNT IDC_STATICCURJOB IDC_STATICNEWJOB


	tbcResult.InsertItem(0,theApp.operCG2.ReadValue("MCG2","UIC_UI_tpgUserInfo"));//玩家基本信息
	tbcResult.InsertItem(1,theApp.operCG2.ReadValue("MCG2","BU_UI_tpgSendItemPwd"));//发送玩家道具密码
...
void CCG2SendItemPwd::OnBnClickedUicancel()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CCG2SendItemPwd::OnSize(UINT nType, int cx, int cy)
{
...
HBRUSH CCG2SendItemPwd::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CCG2SendItemPwd::OnBnClickedUisearch()
{
	// TODO: 在此添加控件通知处理程序代码
	try
	{
...
void CCG2SendItemPwd::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: 在此添加控件通知处理程序代码
	//OperationCG2 theApp.operCG2;
...
// 单击用户列表保存当前行号
void CCG2SendItemPwd::OnNMClickListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: 在此添加控件通知处理程序代码
...
// 双击玩家资料信息进行查询
void CCG2SendItemPwd::OnNMDblclkListuserinfo(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: 在此添加控件通知处理程序代码
	//OperationCG2 theApp.operCG2;
...
//修改玩家角色职业
void CCG2SendItemPwd::OnBnClickedBtupdate()
{
	// TODO: 在此添加控件通知处理程序代码
	try
	{
		...
		socketdata.AddTFLV(CEnumCore::TagName::CG2_ServerName,CEnumCore::TagFormat::TLV_STRING,strlen(ServerName),(unsigned char *)mIni.wcharToChar(ServerName));//服务器IP
		socketdata.AddTFLV(CEnumCore::TagName::CG2_Serverip,CEnumCore::TagFormat::TLV_STRING,strlen(ServerIP),(unsigned char *)mIni.wcharToChar(ServerIP));//服务器IP
		socketdata.AddTFLV(CEnumCore::TagName::CG2_UserName,CEnumCore::TagFormat::TLV_STRING,strlen(UserName),(unsigned char *)mIni.wcharToChar(UserName));//玩家帐号
		...
		socketdata.AddTFLV(CEnumCore::TagName::CG2_TempPwd,CEnumCore::TagFormat::TLV_STRING,strlen(TmpPwd),(unsigned char *)mIni.wcharToChar(TmpPwd));//角色唯一IDKEY


		int midlength = socketdata.EnBody();
		theApp.operCG2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::CG2_Get_EmailAddress);
...
//恢复临时密码
void CCG2SendItemPwd::OnBnClickedBtreset()
{
	CIni mIni;
	CSocketData socketdata;
	socketdata.InitCreate(1,6);//共有五个参数，服务器IP、玩家帐号、角色IDKEY、角色号、新职业、备注
	...
	CString strEmail;
	GetDlgItemText(IDC_ETTMPPWD,strEmail);	
	socketdata.AddTFLV(CEnumCore::TagName::CG2_Email,CEnumCore::TagFormat::TLV_STRING,strlen(strEmail),(unsigned char *)mIni.wcharToChar(strEmail));//e_mail

	int midlength = socketdata.EnBody();
	theApp.operCG2.SendQuery((unsigned char *)socketdata.getDes(),midlength,CEnumCore::ServiceKey::CG2_Send_ItemPassword);
...
LRESULT CCG2SendItemPwd::OnMessageReceive(WPARAM wParam,LPARAM lParam)
{
	...
	case CEnumCore::Message_Tag_ID::CG2_Send_ItemPassword_Resp://道具锁反应
		{
			CGlobalStruct::TFLV m_tflv=socketdata.getTLVBynIndex(1);
			CString result = (LPCTSTR)&m_tflv.lpdata;
...
BOOL CCG2SendItemPwd::PreTranslateMessage(MSG* pMsg)
{
...
//查看临时密码
void CCG2SendItemPwd::OnBnClickedBtseetmppwd()
{
	// TODO: 在此添加控件通知处理程序代码
