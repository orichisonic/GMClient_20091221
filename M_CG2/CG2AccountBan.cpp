...
IMPLEMENT_DYNAMIC(CCG2AccountBan, CDialog)
CCG2AccountBan::CCG2AccountBan(CWnd* pParent /*=NULL*/)
	: CDialog(CCG2AccountBan::IDD, pParent)
{
}

CCG2AccountBan::~CCG2AccountBan()
{
}

void CCG2AccountBan::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCG2AccountBan, CDialog)
...
// 初始化对话框
BOOL CCG2AccountBan::OnInitDialog()
{
...
// 自动改变大小
void CCG2AccountBan::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CCG2AccountBan::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CCG2AccountBan::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
...
// 翻页查询玩家资料信息
void CCG2AccountBan::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
...
// 单击用户列表保存当前行号
void CCG2AccountBan::OnNMClickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CCG2AccountBan::OnNMDblclkListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listUser.GetItemCount() > 0)
...
// 切换选项卡进行查询
void CCG2AccountBan::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
	//OperationCG2 theApp.operCG2;
...
// 翻页进行查询
void CCG2AccountBan::OnCbnSelchangeCmbuipage()
{
	//OperationCG2 theApp.operCG2;	
	try
	{
...
// 接收返回信息
LRESULT CCG2AccountBan::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
// 关闭对话框
void CCG2AccountBan::OnBnClickedUicancel()
{
