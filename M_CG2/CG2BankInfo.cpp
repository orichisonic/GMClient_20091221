...
IMPLEMENT_DYNAMIC(CCG2BankInfo, CDialog)
CCG2BankInfo::CCG2BankInfo(CWnd* pParent /*=NULL*/)
	: CDialog(CCG2BankInfo::IDD, pParent)
{
}

CCG2BankInfo::~CCG2BankInfo()
{
}

void CCG2BankInfo::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CCG2BankInfo, CDialog)
...
// 初始化对话框
BOOL CCG2BankInfo::OnInitDialog()
{
...
// 自动改变大小
void CCG2BankInfo::OnSize(UINT nType, int cx, int cy)
{
...
//设置背景颜色
HBRUSH CCG2BankInfo::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
// 查询玩家资料信息
void CCG2BankInfo::OnBnClickedUisearch()
{
	try
	{
		CIni mIni;
...
// 翻页查询玩家资料信息
void CCG2BankInfo::OnCbnSelchangeCmbuserpage()
{	
	try
	{	
...
// 单击用户列表保存当前行号
void CCG2BankInfo::OnNMClickListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
...
// 双击玩家资料信息进行查询
void CCG2BankInfo::OnNMDblclkListcharacter(NMHDR *pNMHDR, LRESULT *pResult)
{
	if(tbcResult.GetCurSel() == 0)
	{
		if(listUser.GetItemCount() > 0)
...
// 切换选项卡进行查询
void CCG2BankInfo::OnTcnSelchangeTabuiresult(NMHDR *pNMHDR, LRESULT *pResult)
{		
	//OperationCG2 theApp.operCG2;
...
// 翻页进行查询
void CCG2BankInfo::OnCbnSelchangeCmbuipage()
{
	//OperationCG2 theApp.operCG2;	
	try
	{
...
// 接收返回信息
LRESULT CCG2BankInfo::OnMessageReceive(WPARAM wParam, LPARAM lParam)
{	
...
// 关闭对话框
void CCG2BankInfo::OnBnClickedUicancel()
{
